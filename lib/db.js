...
const SCHEMA_SQL = `
  ...
  REVOKE ALL ON kv, users, sessions, password_resets, audit_log, rate_hits, state_backups, clients, tasks, viper_customers, email_messages FROM anon, authenticated;
`;
